  ...
  render() {
    return (
      <Layout>
        ...
        <p className="intro">The real purpose of this website is as a proof of concept e-commerce store powered by Contentful, GatsbyJS, Netlify, serverless, and clay.run. Check out the <a href="https://github.com/njosefbeck/unicorn-mart" target="_blank" rel="noopener noreferrer">repo</a> for more information. This project uses the old Stripe Checkout. For a project that uses the new version of Stripe Checkout, see <a href="https://dragon-mart.netlify.com/">Dragon Mart</a>.</p>
